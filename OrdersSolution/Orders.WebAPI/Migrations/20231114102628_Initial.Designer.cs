...
namespace Orders.WebAPI.Migrations
{
    ...
    [Migration("20231114102628_Initial")]
            ...
            modelBuilder.Entity("Orders.WebAPI.Enteties.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2023, 11, 14, 12, 26, 28, 583, DateTimeKind.Local).AddTicks(784),
                            OrderNumber = "ORD001",
                            TotalAmount = 66.5
                        },
                        new
                        {
                            ...
                            OrderDate = new DateTime(2023, 11, 14, 12, 26, 28, 583, DateTimeKind.Local).AddTicks(811),
                            OrderNumber = "ORD002",
